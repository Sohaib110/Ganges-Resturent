function doPost(e) {
    try {
      var folderId = "1qBsro_S7VhC6rB3YCuFGCXpgo6RFotfI"; 
      var sheetId = "12d6_e3uNRdXvL_pasHQRU2fbHuSq18h5P6aiyV1pmhk";  
      getFolder();
  ...
  function sendVoucherEmail() {
    // sheetId = "1K2Emi5_yafsM6eJh3C-QETRbN9bo0vbWywaHI_EDeRA";
    // var sheet = SpreadsheetApp.openById(sheetId).getActiveSheet();
  ...
  function checkExpiredVouchers() {
    var sheetId = "12d6_e3uNRdXvL_pasHQRU2fbHuSq18h5P6aiyV1pmhk";  // Change this
    var sheet = SpreadsheetApp.openById(sheetId).getActiveSheet();
    var data = sheet.getDataRange().getValues();
